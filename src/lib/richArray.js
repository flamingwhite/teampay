...
if (!Array.prototype.sortBy) {
	Array.prototype.sortBy = function(sort, reverse = false) {
		if (is(Function, sort)) {
			return this.sort((a, b) => !reverse ? sort(a) > sort(b) : sort(a) < sort(b));
		} else if (is(String, sort)) {
			return this.sort((a, b) => !reverse ? a[sort] > b[sort] : a[sort] < b[sort])
		}
		return this;
	}
}
